...
import { URI as URI5, Utils as uriUtils } from "vscode-uri";
var WorkspaceShimService;
  ...
  "src/shims/workspace.ts"() {
    ...
    WorkspaceShimService = class extends Disposable {
      ...
      $getDocumentByLspUri(uri) {
        return this._documents.get(URI5.parse(uri));
      }
      ...
      $openTextDocument(params) {
        ...
        this._documents.set(URI5.parse(uri), doc);
      ...
      $changeTextDocument(params) {
        ...
        const doc = this._documents.get(URI5.parse(uri));
        if (!doc) {
      ...
      $changeWorkspaceFolders(params) {
        ...
        event.added.forEach((folder) => {
          const uri = URI5.parse(folder.uri);
          const addFolder = {
            name: folder.name,
      ...
      $renameFiles(params) {
        const renamedFiles = params.files.map(({ newUri, oldUri }) => ({
          newUri: URI5.parse(newUri),
          oldUri: URI5.parse(oldUri)
        }));
      ...
      asRelativePath(pathOrUri, includeWorkspace) {
        const uri = URI5.isUri(pathOrUri) ? pathOrUri : URI5.file(pathOrUri);
      ...
      async openTextDocument(nameOrUri) {
        const uri = typeof nameOrUri === "string" ? URI5.file(nameOrUri) : nameOrUri;
...
import { URI as URI6, Utils } from "vscode-uri";
...
var TSLspConverter = class extends LspInvariantConverter {
  constructor(clientCapabilities) {
    ...
    this.convertTextDocumentFromLsp = (textDocument) => {
      const uri = URI7.parse(textDocument.uri);
      const doc = {
        uri,
        get version() {
