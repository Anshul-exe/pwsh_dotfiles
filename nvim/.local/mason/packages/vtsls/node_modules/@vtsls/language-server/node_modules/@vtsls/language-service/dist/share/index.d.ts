...
export declare function initializeShareMod(converter: TSLspConverter, workspaceService: WorkspaceShimService): {
    commandsConverter: {
        ...
        "typescript.goToSourceDefinition": {
            fromArgs: (uri: import("vscode-languageserver-protocol").URI, position: import("vscode-languageserver-protocol").Position) => (import("vscode").Position | import("vscode").TextDocument)[];
